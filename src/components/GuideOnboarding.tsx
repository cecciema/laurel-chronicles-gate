        ...
        {step === "choose" && (
          ...
          >
            <div className="text-center mb-10">
              ...
              >
                Each Guide represents a different allegiance: Sanctorium, Parliament, Deep Forge, Convoy Rebellion, and perhaps a hidden fifth... Your choice will shape the path ahead.
              </motion.p>
            </div>
