...
const SCROLLS = [
  ...
  },
  {
    ...
    hint: "Hidden somewhere in the world",
    text: "Not all Sol Deos are born. Some are placed. The selection criteria have never been made public. The criteria exist.",
...
const QuestModal = ({ onClose, onComplete }: { onClose: () => void; onComplete: (a: string) => void }) => {
  ...
  const DOSSIER_CONTENT: Record<AllegianceId, { letter: string; attribution: string; directive: string }> = {
    ...
    deepforge: {
      ...
      directive: "Head to the Quadrants and find the Deep Forge territory. Then go meet the characters who call it home. The community is the point - always has been. Get to know them.",
    },
    convoy: {
