...
export const guideCharacters: GuideCharacter[] = [
  // Row 1: Culver, Quinn, Remsays, Verlaine, Nefertar
  {
    id: "culver",
    name: "Culver Gretell",
  ...
  // Row 2: Soleil, Jude, Carmela, Sailor, Gemma
  {
    id: "soleil",
    name: "Soleil",
    magistry: "Magistry of Ocean",
  ...
  },
  {
    ...
    factionTag: "Parliament · Senior Council",
    philosophy: "Power is most dangerous when it wears the face of love.",
    welcomeTone: "knowing",
    accentColor: "#e8e0d0",
    startingRegion: "The Sanctorium",
    image: "/src/assets/guides/wintry.jpg",
    recommendedLore: ["Parliament", "Space Sciences", "Apotheosis"],
    welcomeMessage: "You found your way here. I suspected you would — people with real questions always do. I won't pretend I don't already know why you've come. Sit. Let me show you what I've learned about this world. All of it. Even the parts that were never meant for you.",
  },
  {
    id: "kotani",
    name: "Kotani",
    ...
    welcomeTone: "resigned",
    accentColor: "#7c6f8e",
    startingRegion: "The Sanctorium",
    image: "/src/assets/guides/kotani.jpg",
    recommendedLore: ["Pantheon", "Meteor", "Sacrifice"],
    welcomeMessage: "I've been expecting someone to ask. Not you specifically — just someone. There comes a point where the weight of what you know becomes unbearable to carry alone. I won't frighten you with everything at once. But I will not lie to you either. That much I can promise.",
  },
  {
    id: "norstrand",
    name: "Norstrand",
    ...
    welcomeTone: "conflicted",
    accentColor: "#b8860b",
    startingRegion: "The Sanctorium",
    image: "/src/assets/guides/norstrand.jpg",
    recommendedLore: ["Pantheon", "Masonry", "Apotheosis"],
    welcomeMessage: "I've presided over more ceremonies than I can count. Spoken words I believed at the time. Built things I thought would stand forever. Come — walk with me. I'll show you what Finnrare was built to protect, and you can decide for yourself whether we succeeded.",
  },
  {
    id: "aspen",
    name: "Aspen",
    magistry: "Parliament — Director of Peace, Northeast",
    factionTag: "Parliament · Affiliation Unknown",
    philosophy: "Every crisis is an opportunity. The question is always — for whom.",
    welcomeTone: "assured",
    accentColor: "#2e5f6e",
    startingRegion: "The Frontier Borderlands",
    image: "/src/assets/guides/aspen.jpg",
    recommendedLore: ["Parliament", "Meteor", "Premiere"],
    welcomeMessage: "Good — you chose well. I know this world from the inside. The Parliament, the Pantheon, the people who actually make decisions and the ones who only think they do. I'll give you the map no one else will. Just keep up — things move fast when you're close to the center of things.",
  },
  {
    id: "lockland",
    name: "Lockland",
    ...
    welcomeTone: "transcendent",
    accentColor: "#c8d8e8",
    startingRegion: "The Sanctorium",
    image: "/src/assets/guides/lockland.jpg",
    recommendedLore: ["Pantheon", "Ivory", "Apotheosis"],
    welcomeMessage: "You've come further than most. I can see it in you — the questions that don't have easy answers, the ones that kept you up at night until you stopped calling them questions and started calling them truths. I have been where you are going. Let me light the path.",
  },
  {
    id: "cora",
    name: "Cora",
    magistry: "Parliament — Council Member",
    factionTag: "Parliament · Cannon Family",
    philosophy: "I told myself everything I did was for my daughters. I'm no longer sure that's true.",
    welcomeTone: "maternal",
    accentColor: "#8b4a3c",
    startingRegion: "The Sanctorium",
    image: "/src/assets/guides/cora.jpg",
    recommendedLore: ["Parliament", "Cannon Family", "Meteor"],
