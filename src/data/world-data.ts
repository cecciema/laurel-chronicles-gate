...
export const characters: Character[] = [
  ...
  },
  {
    ...
    background: "A celebrated scientist who rose to head Parliament's Space Sciences division through genuine brilliance and Karenina's unwavering sponsorship. Wintry shaped careers, funded research, and moved through power with such grace that most people never noticed she was the one holding it. She carries a secret about the afterlife she has never spoken aloud.",
    relationships: "Karenina - the great love of her life, the person she built everything around. Clara/Verlaine - loves her as her own daughter. Parliament - respects her completely, which is exactly how she prefers it.",
  },
  {
    id: "lockland",
    name: "Lockland",
...
export const guideCharacters: GuideCharacter[] = [
  ...
  },
  {
    ...
    startingRegion: "citadel",
    factionTag: "Republic Parliament",
